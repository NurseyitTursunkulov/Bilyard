...
class MyCoroutineWorkerKtTest {
    ...
    fun isWorkingDayFinished() {
        assertEquals(
            true,
            isWorkingDayFinished(
                DateTime.now().minusDays(1).withHourOfDay(9).withMinuteOfHour(0),
    ...
    fun isWorkingDayFinished_previous_day_9_next_11() {
        assertEquals(
            true,
            isWorkingDayFinished(
                DateTime.now().minusDays(2).withHourOfDay(9).withMinuteOfHour(0),
                DateTime.now().withHourOfDay(10).withMinuteOfHour(0)
            )
        )
    }
    ...
    fun from_00_09() {
        assertEquals(
            true,
            isWorkingDayFinished(
                DateTime.now().withHourOfDay(4).withMinuteOfHour(0),
                DateTime.now().withHourOfDay(18).withMinuteOfHour(0)
            )
        )
    }
